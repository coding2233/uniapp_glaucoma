...
text-align: end;" v-model="userInfo.nickName" />
					...
					<cmd-cell-item title="提醒" slot-right arrow>
						<input style="text-align: right;
					text-align: end;" v-model="form.remind" placeholder="请输入" />
					</cmd-cell-item>
					<cmd-cell-item title="时间" slot-right arrow>
						<input @click="handleTap('picker1')" disabled="true" style="text-align: right;
text-align: end;" v-model="form.remindTime" placeholder="请输入时间" />
						<lb-picker ref="picker1" :default-time-limit="50" v-model="form.remindTime" mode="dateSelector"
